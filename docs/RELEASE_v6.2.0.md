...
**Multilingual and safety** — native docs and example skills for Chinese, Japanese, and Korean; cinematic vocabulary for zh/ja/ko/es/ru; production rewrites; false-positive filter repair; and no guessed API, pricing, or model-ID claims.
