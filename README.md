...
An agent that reads the scene before it writes the prompt: text, image, video, and reference-to-video for Seedance 2.0, with native audio, production rewrites, source-dated platform facts, and native reader paths in six languages.
...
![Seedance 2.0 Skill OS infographic: source registry, prompt router, multimodal references, quality gates, and eval loop](assets/skill-os-infographic.png)
